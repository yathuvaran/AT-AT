...
const initialPanes = [
  { title: "Tree 1", content: {dsl: '', tree: ''}, key: 0},
];
...
class App extends React.Component {
  ...
  onChange = (activeKey) => {
    ...
    // for (var i = 0; i < initialPanes.length; i++){
    //   if (initialPanes[i].key == this.currentIndex){
    //     initialPanes[i]['content']['tree'] = tree_data
    //     initialPanes[i]['content']['dsl'] = document.getElementById("DSLTextBox").value
    //   }
    // }
    // console.log(initialPanes)

    
    //tree_data = initialPanes[activeKey]['content']['tree']
    // console.log(document.getElementById("DSLTextBox").value)
    // console.log("activeKey: ", activeKey)
    // console.log("initialPanes", initialPanes)
    // document.getElementById("DSLTextBox").value = initialPanes[activeKey]['content']['dsl'] 
    // console.log(document.getElementById("DSLTextBox").value)
    // console.log(this.currentIndex, activeKey)
